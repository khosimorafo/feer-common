...
public class FeerlarocMultiStateToggleButton extends FeerlarocToggleButton {

    private static final String TAG = FeerlarocMultiStateToggleButton.class.getSimpleName();
    ...
    public FeerlarocMultiStateToggleButton(Context context) {
        super(context, null);
    }
    ...
    public FeerlarocMultiStateToggleButton(Context context, AttributeSet attrs) {
        ...
        try {
            ...
            colorNotPressed = a.getColor(R.styleable.FeerlarocMultiStateToggleButton_mstbSecondaryColor, 0);
            colorPressedText = a.getColor(R.styleable.FeerlarocMultiStateToggleButton_mstbColorPressedText, 0);
            colorPressedBackground = a.getColor(R.styleable.FeerlarocMultiStateToggleButton_mstbColorPressedBackground, 0);
            pressedBackgroundResource = a.getResourceId(R.styleable.FeerlarocMultiStateToggleButton_mstbColorPressedBackgroundResource, 0);
            colorNotPressedText = a.getColor(R.styleable.FeerlarocMultiStateToggleButton_mstbColorNotPressedText, 0);
            colorNotPressedBackground = a.getColor(R.styleable.FeerlarocMultiStateToggleButton_mstbColorNotPressedBackground, 0);
            notPressedBackgroundResource = a.getResourceId(R.styleable.FeerlarocMultiStateToggleButton_mstbColorNotPressedBackgroundResource, 0);
