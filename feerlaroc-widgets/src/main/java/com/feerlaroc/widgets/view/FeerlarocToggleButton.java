...
public abstract class FeerlarocToggleButton extends LinearLayout {
    ...
    FeerlarocToggleButton.OnValueChangedListener listener;
    Context context;
    ...
    public FeerlarocToggleButton(Context context) {
        super(context, null);
        this.context = context;
    }

    public FeerlarocToggleButton(Context context, AttributeSet attrs) {
        super(context, attrs);
        this.context = context;
    }

    public void setOnValueChangedListener(FeerlarocToggleButton.OnValueChangedListener l) {
        this.listener = l;
    }
